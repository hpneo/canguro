  ...
  schema.forEach(function(column) {
    ...
    Object.defineProperty(modelConstructor.prototype, column['name'], {
      ...
      set: function(value) {
        ...
        var hasManyKeys = Object.keys(this.associations.hasMany);

        for (var i = 0; i < hasManyKeys.length; i++) {
          var association = this.associations.hasMany[hasManyKeys[i]];

          console.log(association.fields, association.fields.length === 2, association.fields[1], column['name']);
